...
public class Main extends ListenerAdapter {
    ...
    public static void main(String[] args) throws LoginException {
        JDA jdaBuilder = JDABuilder.createLight("OTg0ODYyMTk3NDMzODkyODg1.GFnYEb.JQ45H1YBrT0PHLLQb2tZo8DfboGchYJH_XkCIs", GatewayIntent.GUILD_MESSAGES, GatewayIntent.DIRECT_MESSAGES, GatewayIntent.GUILD_VOICE_STATES, GatewayIntent.GUILD_MEMBERS)
